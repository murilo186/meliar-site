    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        side === "left" || side === "right"
          ? "inset-y-0 w-[84vw] max-w-sm"
          : "inset-x-0 bottom-0 top-auto max-h-[88vh] w-full rounded-t-2xl border-t",
        className,
      )}
      {...props}
    >
      {children}
      <DialogPrimitive.Close className="absolute right-3 top-3 rounded-full p-2 text-foreground hover:bg-secondary">
        <X className="h-4 w-4" />
