  ...
  return (
    <div className="hidden lg:flex lg:justify-end">
      <Sheet>
        ...
        <SheetContent className="flex w-[430px] max-w-[90vw] flex-col p-0" side="right">
          ...
          <div className="grid flex-1 gap-5 overflow-y-auto px-4 pb-4">
            <div>
          ...
          <div className="grid grid-cols-2 gap-2 border-t border-black/10 px-4 pb-6 pt-4">
            <SheetClose asChild>
