        ...
        <td align="center">
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background:#ffffff;border:1px solid #f3d5df;">
            <tr>
              <td style="padding:24px;">
                <p style="margin:0 0 12px;font-size:12px;font-weight:700;letter-spacing:1.6px;text-transform:uppercase;color:#f74780;">Meliar</p>
                <h2 style="margin:0 0 12px;font-size:24px;line-height:1.2;color:#111111;">Confirme a alteração de e-mail</h2>
                <p style="margin:0 0 8px;font-size:15px;line-height:1.6;color:#333333;">Recebemos uma solicitação para alterar seu e-mail de <strong>{{ .Email }}</strong> para <strong>{{ .NewEmail }}</strong>.</p>
                <p style="margin:0 0 20px;font-size:15px;line-height:1.6;color:#333333;">Se foi você, confirme no botão abaixo.</p>
                <p style="margin:0 0 20px;">
                  <a href="{{ .ConfirmationURL }}" style="display:inline-block;padding:12px 18px;background:#f74780;color:#ffffff;text-decoration:none;font-size:14px;font-weight:700;">Confirmar alteração</a>
                </p>
                <p style="margin:0;font-size:13px;line-height:1.6;color:#666666;">Se você não solicitou essa mudança, ignore este e-mail e entre em contato com o suporte.</p>
              </td>
            </tr>
          </table>
        </td>
